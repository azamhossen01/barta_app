...
<main
      ...
      <section
        ...
        <article
          ...
          <form
            action="{{ route('comments.store', $post->uuid) }}"
            method="POST">
            @csrf 
              ...
              <div class="flex items-start /space-x-3/">
                ...
                <div class="text-gray-700 font-normal w-full">
                  <textarea
                    ...
                    class="flex w-full h-auto min-h-[40px] px-3 py-2 text-sm bg-gray-100 focus:bg-white border border-sm rounded-lg border-neutral-300 ring-offset-background placeholder:text-neutral-400 focus:border-neutral-300 focus:outline-none focus:ring-1 focus:ring-offset-0 focus:ring-neutral-400 disabled:cursor-not-allowed disabled:opacity-50 text-gray-900">{{ old('comment') }}</textarea>
                    @error('comment')
